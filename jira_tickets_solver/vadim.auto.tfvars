...
agent_name = "Complex Terraform Agent"
agent_description = "This agent can deal with complex terraform configurations and uses local embeddings to understand how to deploy them"
agent_runners = [
    "vadim-dont-delete"
  ]
